...
export const findDecorations = (partsCandidate: PartsCandidate, request: SearchRequest, context: SearchContext): Build[] => {
    ...
    function satisfy(): boolean {
        ...
        const unused = [Slot.large, Slot.medium, Slot.small]
